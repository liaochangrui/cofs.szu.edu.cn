...
<ul>
    ...
    <li class="active"><a href="{{ "/others-1" | prepend: "/facilities" | prepend: site.baseurl }}">其它设备</a></li>
</ul>
</div>
...
<div class="wrap oh clearfix" style="float: left; width: 30%" >
    <img src="{{ site.baseurl }}/images/hh-osa.jpg" style="width: 100%; margin: 10px; padding: 10px;" >
    <p style="text-align: center; font-size: 1.0em">
      光谱分析仪  
    </p>
</div>
...
<div class="wrap oh clearfix" style="float: left; width: 30%" >
    <img src="{{ site.baseurl }}/images/al-osa.jpg" style="width: 100%; margin: 10px; padding: 10px;" >
    <p style="text-align: center; font-size: 1.0em">
        光谱分析仪
    </p>
</div>
