...
<div class="wrap clearfix">
    <img src="{{ site.baseurl }}/images/fiber-grating.png" style="float: left; width: 50% ;height: 50% ; margin: 30px; padding: 30px;" >
    <h3>1. 光纤光栅传感技术</h3> 
    <ul>    
...
<div class="wrap clearfix">
    <img src="{{ site.baseurl }}/images/bio-chemical.png" style="float: left; width: 45%; margin: 15px; padding: 15px;" >
    <h3>2. 光纤生化传感技术</h3> 
    <ul>
...
<div class="wrap clearfix">
    <img src="{{ site.baseurl }}/images/interference-sensing.png" style="float: left; width: 45%; margin: 15px; padding: 15px;" >
    <h3>3. 光纤干涉传感技术</h3> 
    <ul>
